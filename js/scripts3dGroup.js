...
function joistClick(a){
    ...
    if(x == 'left'){
        ...
        if($('.activeHold').hasClass('lineTxt')){
            $('.lineTxt').removeClass('activeHold');
            $('#rightPanelBT2').addClass('activeHold');
        }else if($('.activeHold').hasClass('rightItemButRightSide') && y != 0){
...
$('#mmBut').click(function(){
    ...
    if($(this).attr('data-panel-set') == 2){
        ...
        document.location.href = '/circlesGroup.php';
...
$('.saveButton').on('click',function(){
    ...
    if($('.activeHold').hasClass('activeItemGroup')){
        $('.lineTxt').removeClass('activeHold');
        pack = '';
        x = $('.groupDivRightPanel').length
        c = '';
...
/*
    $('.lineTxt').each(function(){
        ...
        if(h == 1){
            ...
            $(this).children('.itemList').children('.groupMark').show();
            $(this).children('.itemList').children('.groupMark').text('3D+');
        }else if(h == 0){
            $(this).children('.itemList').children('.groupMark').hide();
        }
    })
...
$('.lineTxt').each(function(){
    ...
    if(h == 1){
        $(this).children('.itemList').children('.groupMark').show();
        $(this).children('.itemList').children('.groupMark').text('3D1');
        ...
        $(this).children('.itemList').children('.groupMark2').text('3D2');
        $(this).children('.itemList').children('.groupMark3').hide();
        $(this).children('.itemList').children('.groupMark4').hide();
        $(this).children('.itemList').children('.groupMark5').hide();
    }else if(h == 3){
        ...
        $(this).children('.itemList').children('.groupMark3').text('3D3');
        $(this).children('.itemList').children('.groupMark4').hide();
        $(this).children('.itemList').children('.groupMark5').hide();
    }else if(h == 4){
        $(this).children('.itemList').children('.groupMark').show();
        ...
        $(this).children('.itemList').children('.groupMark4').text('3D4');
        $(this).children('.itemList').children('.groupMark5').hide();
    }else if(h == 5){
        $(this).children('.itemList').children('.groupMark').show();
        $(this).children('.itemList').children('.groupMark').text('3D1');
        ...
        $(this).children('.itemList').children('.groupMark5').text('3D5');
    }else if(h == 0){
        $(this).children('.itemList').children('.groupMark').hide();
        $(this).children('.itemList').children('.groupMark2').hide();
        $(this).children('.itemList').children('.groupMark3').hide();
