...
<link rel="stylesheet" type="text/css" href="css/stylePresets.css" >
...
if($load == 'menu'){ ?>
    ...
    <div class="escButtonBig menuBack"></div>
    ...
    <div class="joist">
        ...
        <div class="stickWrap">
            ...
            <div class="rotateJoist">
                ...
                <div id="centerJRotate" onclick="joistClick(this)" data-rotate="0" class="mainJRot"></div>
        ...
        <div class="deleteWrap">
            ...
            <div class="middleLine">
                ...
                <div class="row middleRow">
                    <div class="listDiv col-8 col-xs-8 col-sm-8 col-lg-12">
                            ...
                            <div class="row">
                                <div style="padding-left:20px;" class="nameText titleUpText col-4 col-xs-4 col-sm-4 col-lg-4">
                                    Bolshoy Teatr
                                </div>
                                <div style="padding-left:20px;" class="nameText titleUpText col-4 col-xs-4 col-sm-4 col-lg-4">
                                    Presets
                            ...
                            <div id="topAnchor" class="row">
                                ...
                                <div id="mainPreset" class="titleUpTextIn col-4 col-xs-4 col-sm-4 col-lg-4">
                                
                                    <div class="row">

                                        <div id="mPreset1" data-items='' data-m-preset="1" class="activeFreeze mainPresetDiv choiseGroup col-12 col-xs-12 col-sm-12 col-lg-12">
                                        <span class="num1">S</span>pectate 1
                                        </div>
                                        <div id="mPreset2" data-items='' data-m-preset="2" class="mainPresetDiv col-12 col-xs-12 col-sm-12 col-lg-12">
                                        <span class="num1">S</span>pectate 2
                                        </div>
                                        <div id="mPreset3" data-items='' data-m-preset="3" class="mainPresetDiv col-12 col-xs-12 col-sm-12 col-lg-12">
                                        <span class="num1">S</span>pectate 3
                                        </div>
                                        <div id="mPreset4" data-items='' data-m-preset="4" class="mainPresetDiv col-12 col-xs-12 col-sm-12 col-lg-12">
                                        <span class="num1">S</span>pectate 4
                                        </div>
                                        <div id="mPreset5" data-items='' data-m-preset="5" class="mainPresetDiv col-12 col-xs-12 col-sm-12 col-lg-12">
                                        <span class="num1">S</span>pectate 5
                                        </div>
                                ...
                                <div id="toPlaylist" class="titleUpTextIn col-4 col-xs-4 col-sm-4 col-lg-4">
                                    ...
                                    for($i=1;$i<15;$i++){ 
                                        ...
                                        if($i == 1){
                                            ?>
                                                ...
                                                <div data-panel="left" data-item="<? echo $i-2 ?>" data-preset="<? echo $i-2 ?>" class="itemLeft noTouch<? echo $style; ?>">● <span class="num1">P</span>arking</div>

                                            <?
                                        }else if($i == 2){
                                            ?>

                                                <div data-panel="left" style="border-bottom:2px solid #696969;" data-item="<? echo $i-2 ?>" data-preset="<? echo $i-2 ?>" class="itemLeft noTouch<? echo $style; ?>">● <span class="num1">D</span>own all</div>
                                    ...
                                    <div data-panel="left" data-item="<? echo $i-2 ?>" data-preset="<? echo $countH ?>" class="itemLeft <? echo $style; ?>"><span class="num1">P</span>reset <? echo $countH; ?></div>
            ...
            <div class="downLineButtons">
                <div class="row">
                    <div data-slide="0" id="downPanelLeft" data-panel-set='1' class="noText downButs col-2 col-xs-2 col-sm-2 col-lg-2"></div>
                    ...
                    <div data-slide="0" class="escBut downButs col-2 col-xs-2 col-sm-2 col-lg-2">View</div>
                </div>
            </div>
            </div>
        </div>
...
<script src="js/scriptsPresets.js"></script>
</body>
</html>